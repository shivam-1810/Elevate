...
import 'package:elevate/student/home/components/student_row.dart';
import 'package:flutter/material.dart';
import 'package:shared_preferences/shared_preferences.dart';
import 'package:http/http.dart' as http;

class MyCollegeMates extends StatefulWidget {
  final int? userId;
  final String collegeId;
  final String collegeName;
  const MyCollegeMates(
      {super.key,
  ...
  @override
  State<MyCollegeMates> createState() => _MyCollegeMatesState();
}

class _MyCollegeMatesState extends State<MyCollegeMates> {
  String? authToken;
                ...
                : ListView.builder(
                    ...
                    itemBuilder: (context, idx) {
                      ...
                      return StudentRow(
                        ...
                        gradientColors: (student['userId'] != null &&
                                widget.userId != null &&
                            ...
                            : (idx % 2 == 0)
                                ? [
                                    const Color.fromARGB(255, 35, 161, 157),
                                    const Color(0xFF93EDC7),
                                  ]
                                : [
                                    const Color.fromARGB(255, 174, 112, 138),
                                    const Color.fromARGB(255, 180, 105, 117),
                                  ],
                      );
                    },
                  ),
