import 'package:elevate/student/editable_forms/education_details.dart';
...
class EducationDetailsCard extends StatefulWidget {
  final int userId;
  ...
  @override
  State<EducationDetailsCard> createState() => _EducationDetailsCardState();
}

class _EducationDetailsCardState extends State<EducationDetailsCard> {
  @override
  Widget build(BuildContext context) {
    return Center(
      child: Container(
                ...
                IconButton(
                  ...
                  onPressed: () {
                    Navigator.of(context).push(MaterialPageRoute(
                        builder: (context) => EducationDetailsForm(
